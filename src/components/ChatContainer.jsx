    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        ...
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          />
          <input onChange={handleSendImage} type="file" id='image' accept='image/png, image/jpg' hidden className='' />
          <label htmlFor="image">
            <img src={assets?.gallery_icon} alt="gallery-icon" className='w-5 mr-2 cursor-pointer ' />
          </label>
        </div>

        <img onClick={handleSendMessage} src={assets?.send_button} alt="send message" className='w-7 cursor-pointer' />
